							...
							<table class="table table-striped table-bordered table-hover dataTables-example" >
								<thead>
									<tr>
                                        ...
                                        <th style="width:81px;">Đặc điểm sản phẩm</th>
                                        <th style="width:81px;">Chọn mua hàng</th>
										<?php /*
										<th style="width:81px;">Khách sạn</th>
										<th style="width:81px;">Car</th><th style="width:81px;">Màu sắc</th>
                                        <th style="width:81px;">Vị trí</th>
                                        <th style="width:81px;">Nổi bật</th>
                                        <th style="width:81px;">Chọn một</th>
                                        */?>
										...
										<?php foreach($listCatalogue as $key => $val){ ?>
											<tr class="gradeX" id="cat-<?php echo $val['id']; ?>">
                                                ...
                                                <?php /*<td>
                                                    <div class="switch">
                                                        <div class="onoffswitch">
                                                            <input type="checkbox" <?php echo ($val['tour'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="attribute_catalogue" data-title="tour" data-id="<?php echo $val['id']; ?>" id="publish_tour<?php echo $val['id']; ?>">
                                                            <label class="onoffswitch-label" for="publish_tour<?php echo $val['id']; ?>">
                                                ...
                                                <td>
                                                    <div class="switch">
                                                        <div class="onoffswitch">
                                                            <input type="checkbox" <?php echo ($val['room'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="attribute_catalogue" data-title="room" data-id="<?php echo $val['id']; ?>" id="publish_room<?php echo $val['id']; ?>">
                                                            <label class="onoffswitch-label" for="publish_room<?php echo $val['id']; ?>">
                                                                <span class="onoffswitch-inner"></span>
                                                                <span class="onoffswitch-switch"></span>
                                                            </label>
                                                        </div>
                                                ...
                                                <td>
                                                    <div class="switch">
                                                        <div class="onoffswitch">
                                                            <input type="checkbox" <?php echo ($val['car'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="attribute_catalogue" data-title="car" data-id="<?php echo $val['id']; ?>" id="publish_car<?php echo $val['id']; ?>">
                                                            <label class="onoffswitch-label" for="publish_car<?php echo $val['id']; ?>">
                                                                <span class="onoffswitch-inner"></span>
                                                                <span class="onoffswitch-switch"></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="switch">
                                                        <div class="onoffswitch">
                                                            <input type="checkbox" <?php echo ($val['issearch'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="attribute_catalogue" data-title="issearch" data-id="<?php echo $val['id']; ?>" id="publish_issearch<?php echo $val['id']; ?>">
                                                            <label class="onoffswitch-label" for="publish_issearch<?php echo $val['id']; ?>">
                                                                <span class="onoffswitch-inner"></span>
                                                                <span class="onoffswitch-switch"></span>
                                                            </label>
                                                        </div>
                                                ...
                                                <td>
                                                    <div class="switch">
                                                        <div class="onoffswitch">
                                                            <input type="checkbox" <?php echo ($val['isaside'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="attribute_catalogue" data-title="isaside" data-id="<?php echo $val['id']; ?>" id="publish_isaside<?php echo $val['id']; ?>">
                                                            <label class="onoffswitch-label" for="publish_isaside<?php echo $val['id']; ?>">
                                                                <span class="onoffswitch-inner"></span>
                                                                <span class="onoffswitch-switch"></span>
                                                            </label>
                                                        </div>
