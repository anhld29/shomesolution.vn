        ...
        <ul class="nav metismenu" id="side-menu">
            ...
            <?php if (in_array('job/backend/job/view', json_decode($this->auth['permission'], TRUE)) && in_array('job', $dropdown)) { ?>
                <li class="<?php echo ($this->router->module == 'job') ? 'active' : '' ?>">
                    <a href="#"><i class="fa fa-tag"></i> <span class="nav-label">Quản lý dịch vụ</span><span  class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="<?php echo site_url('job/backend/catalogue/view'); ?>">Quản lý danh mục dịch vụ</a></li>
                        <li><a href="<?php echo site_url('job/backend/job/view'); ?>">Quản lý dịch vụ</a></li>
                    </ul>
                </li>
            <?php } ?>
            <?php if (in_array('item/backend/item/view', json_decode($this->auth['permission'], TRUE)) && in_array('item', $dropdown)) { ?>
                <li class="<?php echo ($this->router->module == 'item') ? 'active' : '' ?>">
                    <a href="#"><i class="fa fa-tag"></i> <span class="nav-label">Quản lý tra cứu</span><span  class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="<?php echo site_url('item/backend/catalogue/view'); ?>">Quản lý danh mục</a></li>

                        <li><a href="<?php echo site_url('item/backend/item/view'); ?>">Danh sách</a></li>
                    </ul>
                </li>
            <?php } ?>
            <?php if (in_array('software/backend/software/view', json_decode($this->auth['permission'], TRUE)) && in_array('software', $dropdown)) { ?>
                <li class="<?php echo ($this->router->module == 'software') ? 'active' : '' ?>">
                    <a href="#"><i class="fa fa-tag"></i> <span class="nav-label">Quản lý phần mềm tính toán</span><span  class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="<?php echo site_url('software/backend/catalogue/view'); ?>">Quản lý danh mục</a></li>

                        <li><a href="<?php echo site_url('software/backend/software/view'); ?>">Danh sách</a></li>
                    </ul>
                </li>
            <?php } ?>
            ...
            <?php if (in_array('support/backend/support/view', json_decode($this->auth['permission'], TRUE)) && in_array('support', $dropdown)) { ?>
                ...
                <li class="<?php echo ($this->router->module == 'support') ? 'active' : '' ?>">
                    <a href="#"><i class="fa fa-users"></i><span class="nav-label">Danh sách cửa hàng</span><span
                                class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li class="hidden"><a href="<?php echo site_url('support/backend/catalogue/view'); ?>">Tỉnh thành/Quận huyên</a></li>
            ...
            <?php if (in_array('contact/backend/contact/view', json_decode($this->auth['permission'], TRUE)) && in_array('contact', $dropdown)) { ?>
                ...
                <li class="<?php echo ($this->router->module == 'contact') ? 'active' : '' ?>">
                    <a href="#"><i class="fa fa-envelope"></i><span class="nav-label">Liên Hệ</span><span
                                class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li class="hide"><a href="<?php echo site_url('contact/backend/catalogue/view'); ?>">Nhóm liên hệ</a></li>
                        <li class="hide"><a href="<?php echo site_url('contact/backend/contact/view'); ?>">Danh sách liên hệ</a></li>
