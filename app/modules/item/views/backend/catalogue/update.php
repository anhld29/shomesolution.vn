                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="google">
                                        ...
                                        <div
                                            ...
                                            class="g-title"><?php echo ($this->input->post('meta_title')) ? $this->input->post('meta_title') : (($this->input->post('title')) ? $this->input->post('title') : (($detailCatalogue['meta_title'] != '') ? $detailCatalogue['meta_title'] : $detailCatalogue['title'])); ?></div>

                                        <div

                                            class="g-link"><?php echo ($this->input->post('canonical')) ? site_url($this->input->post('canonical')) : site_url($detailCatalogue['canonical']); ?></div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                                ...
                                                <span style="color:#9fafba;"><span
                                                        ...
                                                        id="titleCount"><?php echo strlen($detailCatalogue['meta_title']) ?></span> trên 70 ký tự</span>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                                ...
                                                <span style="color:#9fafba;"><span
                                                        ...
                                                        id="descriptionCount"><?php echo strlen($detailCatalogue['meta_description']) ?></span> trên 320 ký tự</span>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="block clearfix">
                                            ...
                                            <div class="i-checks mr30" style="width:100%;"><span
                                                    ...
                                                    style="color:#000;"> <input <?php echo ($this->input->post('publish') == 0) ? 'checked' : (($detailCatalogue['publish'] == 0) ? 'checked' : '') ?>
                                        ...
                                        <div class="block clearfix">
                                            ...
                                            <div class="i-checks" style="width:100%;"><span style="color:#000;"> <input
                                                        ...
                                                        type="radio" <?php echo ($this->input->post('publish') == 1) ? 'checked' : (($detailCatalogue['publish'] == 1) ? 'checked' : '') ?>

                                                        class="popup_gender_0 gender" required value="1" name="publish"> <i></i> Tắt chức năng hiển thị trên website. </span>
