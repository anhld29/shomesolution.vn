            ...
            <div class="row">
                <div class="col-lg-8 clearfix">
                    <ul class="nav nav-pills ">
                        ...
                        <li class=""><a data-toggle="tab" href="#home1">Cửa hàng có sẵn hàng</a></li>
                        ...
                        <div id="home1" class="tab-pane fade">
                            ...
                            <div class="ibox mb20 block-detail-product">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="row">
                                        <?php
                                        $store = $this->input->post('store'); // mảng danh mục
                                        ...
                                        <?php if (!empty($Liststores)) { ?>

                                            <?php foreach ($Liststores as $k => $v) { ?>
                                                <div class="col-md-12">
                                                    <label for="store<?php echo $v['id'] ?>">
                                                        <?php if (!empty($store)) { ?>
                                                            <?php echo form_checkbox('store[]', $v['id'], set_checkbox('store[]', $v['id'], FALSE), ((isset($store) && in_array($v['id'], $store)) ? 'checked="checked" id="store' . $v['id'] . '"' : 'id="store' . $v['id'] . '"')); ?>
                                                        <?php } else { ?>
                                                            <?php echo form_checkbox('store[]', $v['id'], set_checkbox('store[]', $v['id'], FALSE), 'id="store' . $v['id'] . '" checked="checked"'); ?>
                                                        <?php } ?>
                                                        <?php echo $v['address'] ?>
                                                    </label>
                                                </div>
