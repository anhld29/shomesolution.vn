                            ...
                            <div class="ibox mb20 block-detail-product">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="row">
                                        ...
                                        if(!empty($this->input->post('store'))){
                                            $store = $this->input->post('store');
                                        }else{
                                            $store = json_decode($product['store'], TRUE);
                                        }
                                            ...
                                            <?php foreach ($Liststores as $k => $v) { ?>
                                                <div class="col-md-12">
                                                    <label for="store<?php echo $v['id'] ?>">
                                                        <?php echo form_checkbox('store[]', $v['id'], set_checkbox('store[]', $v['id'], FALSE), (isset($store) && count($store) && is_array($store) && in_array($v['id'], $store)) ? 'checked="checked" id="store' . $v['id'] . '"' : 'id="store' . $v['id'] . '"'); ?>
                                                        <?php echo $v['address'] ?>
                                                    </label>
                                                </div>
                                            <?php } ?>
