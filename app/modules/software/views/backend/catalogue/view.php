					...
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-software">
								...
								<li><a type="button" class="ajax-delete-all" data-title="Lưu ý: Khi bạn xóa danh mục bài viết, toàn bộ bài viết trong nhóm này sẽ bị xóa. Hãy chắc chắn rằng bạn muốn thực hiện chức năng này!" data-module="software_catalogue">Xóa tất cả</a>
							...
							<div class="uk-flex uk-flex-middle uk-flex-space-between">
								...
								<div class="perpage">
									...
									<div class="uk-flex uk-flex-middle mb10 hidden">
										...
										<?php echo form_dropdown('perpage', $this->configbie->data('perpage'), set_value('perpage',$this->input->get('perpage')) ,'class="form-control input-sm perpage filter"  data-url="'.site_url('software/backend/catalogue/view').'"'); ?>
								...
								<div class="toolbox">
									...
									<div class="uk-flex uk-flex-middle uk-flex-space-between">
										...
										<div class="uk-button hidden">
											...
											<a href="<?php echo site_url('software/backend/catalogue/create'); ?>" class="btn btn-danger"><i class="fa fa-plus"></i> Thêm danh mục bài viết mới</a>
										...
										?>
											...
											<tr class="gradeX" id="cat-<?php echo $val['id']; ?>">
												...
												<td>
													...
													<a class="maintitle" style="<?php echo ($val['level'] == 1) ? 'font-weight:600;' : ''; ?>" href="<?php echo site_url('software/backend/software/view?catalogueid='.$val['id'].''); ?>" title=""><?php echo str_repeat('|----', (($val['level'] > 0)?($val['level'] - 1):0)).$val['title']; ?> (<?php echo $count; ?>)</a>
												...
												<td>
													...
													<?php echo form_input('order['.$val['id'].']', $val['order'], 'data-module="software_catalogue" data-id="'.$val['id'].'"  class="form-control sort-order" placeholder="Vị trí" style="width:50px;text-align:right;"');?>
												...
												<td>
													...
													<div class="switch">
														...
														<div class="onoffswitch">
															...
															<input type="checkbox" <?php echo ($val['ishome'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="software_catalogue" data-title="ishome" data-id="<?php echo $val['id']; ?>" id="publish_ishome<?php echo $val['id']; ?>">
												...
												<td class="text-center">
													...
													<a type="button" href="<?php echo site_url('software/backend/catalogue/update/'.$val['id'].'') ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>

													<a <?php echo ($val['rgt'] - $val['lft'] > 1) ? 'disabled="disabled" ': ''; ?> type="button" class="btn btn-danger <?php echo ($val['rgt'] - $val['lft'] > 1) ? '" ': 'ajax-delete'; ?>" data-title="Lưu ý: Khi bạn xóa danh mục, toàn bộ bài viết trong nhóm này sẽ bị xóa. Hãy chắc chắn rằng bạn muốn thực hiện hành động này!" data-router="<?php echo $val['canonical']; ?>" data-id="<?php echo $val['id'] ?>" data-module="software_catalogue" data-child="1"><i class="fa fa-trash"></i></a>
