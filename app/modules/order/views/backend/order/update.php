                            ...
                            <div class="ibox-content">
                                <div class="row m-b">
                                    <table class="table shoping-cart-table">
                                        <tbody>
                                        <?php $giagoc = 0;
                                        if (isset($data_order['list_product']) && is_array($data_order['list_product']) && count($data_order['list_product'])) { ?>
                                            <?php foreach ($data_order['list_product'] as $key => $val) {
                                                $quantity = $val['qty'];
                                                if (!empty($val['giagoc']) && $val['giagoc'] > 0) {
                                                    $giagoc += ($val['price'] - $val['giagoc']) * $val['qty'];
                                                }
                                                ...
                                                <tr>
		                                        	...
		                                        	<span class="img-scaledown image-post">
			                                        	<img src="<?php echo $val['detail']['image'] ?>">
		                                        	</span>
                                                    </td>
                                                    <td class="desc">
                                                        <h5><a href="#" class="">
                                                    ...
                                                    <td>
			                                    	<span>
			                                    		<span class="" data-val="<?php echo $val['qty'] ?>">
			                                    		<?php echo $val['qty'] ?>
				                                    	</span>
                                                        ...
                                                        <span>x</span>
                                                        <?php echo addCommas($price_final) ?>
                                                        <span>đ</span>
                                                    </td>
                                                    <td>
                                                        <b class="nowrap">
