								...
								<div class="col-lg-12">
									<div class="form-row">
										<label class="control-label text-left">
											<span>Tên dự án <b class="text-danger">(*)</b></span>
										</label>
							...
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_input('vitri', htmlspecialchars_decode(html_entity_decode(set_value('vitri'))), 'class="form-control" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_input('diadiem', htmlspecialchars_decode(html_entity_decode(set_value('diadiem'))), 'class="form-control" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15 ">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_input('mucluong', htmlspecialchars_decode(html_entity_decode(set_value('mucluong'))), 'class="form-control" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15 hidden">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_input('hannophoso', htmlspecialchars_decode(html_entity_decode(set_value('hannophoso'))), 'class="form-control form-control  datetimepicker" placeholder="" id="date_modified" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<div class="row mb15">
