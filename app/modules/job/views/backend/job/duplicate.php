                    ...
                    <div class="ibox mb20 hidden">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        <?php echo form_textarea('video', set_value('video', $detailjob['video']), 'class="form-control"  rows="4"  placeholder="" autocomplete="off" ');?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-row uk-flex uk-flex-middle">
                                        <div class="icon_hot m-r" style="cursor: pointer;"><img src="<?php echo ($this->input->post('icon')) ? $this->input->post('icon') : ( (!empty($detailjob['icon']))? $detailjob['icon'] :'template/not-found.png' )	 ?>" class="img-thumbnail" alt=""></div>
                                        <?php echo form_hidden('icon', htmlspecialchars_decode(html_entity_decode(set_value('icon', $detailjob['icon']))), 'class="form-control " placeholder="" onclick="openKCFinder(this)"  autocomplete="off"');?>
					...
					<div class="ibox mb20 hidden">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										<?php echo form_dropdown('amp', $this->configbie->data('amp'), set_value('amp', $detailjob['amp']), 'class="form-control m-b select3"');?>
									</div>
								</div>
							</div>
						</div>
