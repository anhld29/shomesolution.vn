                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div class="featured-imagebox featured-imagebox-post box-shadow">
                                <div class="featured-thumbnail">
                                    <a href="<?php echo $href; ?>"> <img class="img-fluid" src="<?php echo $image; ?>" alt="<?php echo $title; ?>" style="height: 249px;object-fit: contain;width: 100%"></a>
                                ...
                                <div class="featured-content featured-content-post">
                                    ...
                                    <div class="post-meta">
                                        <span class="ttm-meta-line"><i class="fa fa-calendar"></i><?php echo $val['created'] ?></span>
                                        <span class="ttm-meta-line"><i class="fa fa-eye"></i><?php echo $val['viewed'] ?> <?php echo $this->lang->line('luotxem')?></span>
                                    </div>
